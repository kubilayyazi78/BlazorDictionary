...
public class Worker : BackgroundService
{
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        QueueFactory.CreateBasicConsumer()
            .EnsureExchange(BlazorConstants.UserExchangeName)
            .EnsureQueue(BlazorConstants.UserEmailChangedQueueName, BlazorConstants.UserExchangeName)
            ...
            .StartConsuming(BlazorConstants.UserEmailChangedQueueName);
    }
}